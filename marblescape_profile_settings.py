...
class ProfilesSettings:
    def __init__(self, parent, library, capture_settings, on_load,
        ...
        self.tree.column("name", width=150, minwidth=45, stretch=False)
        self.tree.column("source", width=95, minwidth=45, stretch=False)
        self.tree.column("selection", width=205, minwidth=45, stretch=False)
        self.tree.column("time", width=175, minwidth=45, stretch=False)
